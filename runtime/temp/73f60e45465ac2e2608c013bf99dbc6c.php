<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/mnt/www/html/myphpweb/apps/admin/view/valuablesinfo/index.html";i:1483705683;s:24:"public/header/index.html";i:1484568712;s:23:"public/header/head.html";i:1484653862;}*/ ?>

<link href="___PUBLIC__/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
<link href="___PUBLIC__/global/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
<link href="___PUBLIC__/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<link href="___PUBLIC__/global/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css" />
<link href="___PUBLIC__/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet" type="text/css" />
<!-- END GLOBAL MANDATORY STYLES -->

<link href="___PUBLIC__/global/plugins/datatables/datatables.min.css" rel="stylesheet" type="text/css" />

<!-- BEGIN PAGE LEVEL PLUGINS -->
<link href="___PUBLIC__/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
<link href="___PUBLIC__/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL STYLES -->
<link href="___PUBLIC__/global/css/components-rounded.min.css" rel="stylesheet" id="style_components" type="text/css" />
<link href="___PUBLIC__/global/css/plugins.min.css" rel="stylesheet" type="text/css" />
<!-- END THEME GLOBAL STYLES -->
<!-- BEGIN PAGE LEVEL STYLES -->
<link href="___PUBLIC__/pages/css/login-4.css" rel="stylesheet" type="text/css" />
<!-- BEGIN THEME LAYOUT STYLES -->
<link href="___PUBLIC__/layouts/layout/css/layout.min.css" rel="stylesheet" type="text/css" />
<link href="___PUBLIC__/layouts/layout/css/themes/light2.min.css" rel="stylesheet" type="text/css" id="style_color" />

<!-- END THEME LAYOUT STYLES -->

<!--[if lt IE 9]-->
<script src="___PUBLIC__/global/plugins/respond.min.js"></script>
<script src="___PUBLIC__/global/plugins/excanvas.min.js"></script>
<!--[endif]-->
<!-- BEGIN CORE PLUGINS -->
<script src="___PUBLIC__/global/plugins/jquery.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/js.cookie.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/jquery.blockui.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/uniform/jquery.uniform.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="___PUBLIC__/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
<script src="___PUBLIC__/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="___PUBLIC__/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<script src="___PUBLIC__/global/scripts/addtable.js" type="text/javascript"></script>
...
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            <a href="<?php echo url('admin/majorinfo/MajorInfo'); ?>">贵重物品管理</a>
...
<div class="portlet light bordered" >
    ...
    <div class="portlet-title">
        <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase">贵重物品登记信息表</span>
        </div>
        <div class="tools">
            <div class="row">
                <div class="col-md-12">
        ...
        <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
            ...
            <div class="table-scrollable">
                <table class="table">
                    <thead>
                    <tr >
                        <th class="sorting_desc" style="width: 8%;" >
                            姓名
                        </th>
                        ...
                        <th class="sorting" style="width: 24%;" >
                            贵重物品
                        </th>
                        <th class="sorting" style="width: 20%;" >
                            登记时间
                        </th>
                        <th class="sorting" style="width: 13%;" >
                            联系电话
                        </th>
                    </tr>
                    </thead>
                    <tbody id="Major_row">
                    <?php if(is_array($valuables) || $valuables instanceof \think\Collection): $i = 0; $__LIST__ = $valuables;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                   <tr role="row" class="even" >
                       <td id="td_row_StudentName_<?php echo $vo['ValuablesId']; ?>">
                            <?php echo $vo['StudentName']; ?>
                       </td>
                       <td id="td_row_Major_<?php echo $vo['ValuablesId']; ?>">
                           <?php echo $vo['MajorName']; ?>-<?php echo $vo['ClassName']; ?>
                       </td>
                       <td id="td_row_Dormitory_<?php echo $vo['ValuablesId']; ?>">
                           <?php echo $vo['Building']; ?>-<?php echo $vo['Unit']; ?>-<?php echo $vo['DormitoryNo']; ?>
                       </td>
                       <td id="td_row_Valuables_<?php echo $vo['ValuablesId']; ?>">
                           <?php echo $vo['ValuablesName']; ?>
                       </td>
                       <td id="td_row_RegistrationTime_<?php echo $vo['ValuablesId']; ?>">
                           <?php echo $vo['RegistrationTime']; ?>
                       </td>
                       <td id="td_row_PhoneNo_<?php echo $vo['ValuablesId']; ?>">
                           <?php echo $vo['PhoneNo']; ?>
                       </td>
                    </tr>
